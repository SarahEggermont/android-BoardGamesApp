...
data class ApiCafe(
    ...
    val catname_en: String,
    val catname_fr: String,
    val catname_de: String,
    val catname_es: String,
    val ctcname: String,
    val address: String,
    val postal: String,
    val local: String,
...
fun ApiCafe.asDomainObject(): Cafe {
    return Cafe(
        ...
        catnameEn = this.catname_en,
        catnameFr = this.catname_fr,
        catnameDe = this.catname_de,
        catnameEs = this.catname_es,
        ctcname = this.ctcname,
